...
class MetaScraper(HTMLArticleScraper):
    """
    Scraper for Meta AI blog articles.
    Extracts articles from ai.meta.com/blog/
    """

    name = "meta_scraper"
    
    # Custom settings for Meta AI blog
    custom_settings = {
        "CONCURRENT_REQUESTS": 1,
        "DOWNLOAD_DELAY": 5,  # Increased delay for Meta
        ...
        "PLAYWRIGHT_DEFAULT_NAVIGATION_TIMEOUT": 120000,  # Increased timeout
    }
    ...
    def get_author(self, response) -> Optional[str]:
        ...
        No author information available for Meta AI blog
        """
        return None
    ...
    def load_more_articles(self, response) -> None:
        ...
        No pagination needed for Meta AI blog as specified.
        """
        # No pagination needed for Meta AI blog
        pass
